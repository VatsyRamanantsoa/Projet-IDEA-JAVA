...
const handleSubmit = async (e) => {
  ...
  try {
    const res = await login({
      username: username,   // ⚠️ username utilisé comme username
      password: password
    });
    ...
    return (
      <div className="min-h-screen bg-mauve-300 flex items-center justify-center p-4 relative overflow-hidden font-sans">
        ...
        <div className="relative z-10 w-full max-w-5xl">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row h-[500px]">
            ...
            <div className="md:w-150 p-8 md:p-12 flex flex-col justify-center bg-white">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {/* Submit Button - Couleurs landing page */}
                <button 
                  type="submit" 
                  disabled={isLoading}
